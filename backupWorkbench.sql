CREATE DATABASE  IF NOT EXISTS `db_faculdade3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_faculdade3`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: db_faculdade3
-- ------------------------------------------------------
...
INSERT INTO `curso` VALUES (1,'Engenharia de Software',5),(2,'Analise de Sistemas',4),(3,'Biologia',3),(4,'História',1),(5,'Matematica',2),(6,'Engenharia Elétrica',2),(7,'Psicologia',1),(8,'Educação Física',4),(9,'Ciência da Computação',5),(10,'Letras',1);
...
INSERT INTO `departamento` VALUES (1,'Ciencias Humanas'),(2,'Matemática'),(3,'Biológicas'),(4,'Estágio'),(5,'TI');
...
-- Dump completed on 2022-06-09 16:44:26
